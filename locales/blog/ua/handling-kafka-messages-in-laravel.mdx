...
- [Встановлення та налаштування](#installation-and-configuration)
- [Провайдер та сервіс для роботи з Kafka](#provider-and-service-for-handling-kafka)
- [Відправка та отримання повідомлень Kafka у Laravel](#producing-and-consuming-kafka-messages-in-laravel)
- [Наступні кроки та найкращі практики](#next-steps-and-best-practices)
